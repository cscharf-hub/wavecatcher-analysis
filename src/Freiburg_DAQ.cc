...
void Freiburg_DAQ::ReadFileFreiburg(string path, bool change_polarity, string out_file_name) {
	...
	printf("Finished reading %d events with %d channels.\n\n", nevents, nchannels);
}
